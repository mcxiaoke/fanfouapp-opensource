...
public final class Constants {
    ...
    public static final String ACTION_STATUS = Constants.ACTION_PACKAGE
            + "STATUS";
    public static final String ACTION_SHARE = Constants.ACTION_PACKAGE
            + "SHARE";
    public static final String ACTION_SEARCH = Constants.ACTION_PACKAGE
            + "SEARCH";
    public static final String ACTION_MESSAGES = Constants.ACTION_PACKAGE
            + "MESSAGES";

    public static final String ACTION_ALARM_NOTITICATION = Constants.ACTION_PACKAGE
            + "ALARM_NOTITICATION";
    public static final String ACTION_ALARM_AUTO_COMPLETE = Constants.ACTION_PACKAGE
            + "ALARM_AUTO_COMPLETE";
    public static final String ACTION_ALARM_AUTO_UPDATE_CHECK = Constants.ACTION_PACKAGE
            + "AUTO_UPDATE_CHECK";

    public static final String ACTION_NOTIFICATION = Constants.ACTION_PACKAGE
            + "NOTIFICATION";
    public static final String ACTION_SEND = Constants.ACTION_PACKAGE + "SEND";
    public static final String ACTION_SEND_FROM_GALLERY = Constants.ACTION_PACKAGE
            + "GALLERY";
    public static final String ACTION_SEND_FROM_CAMERA = Constants.ACTION_PACKAGE
            + "CAMERA";
    public static final String ACTION_MESSAGE_SENT = Constants.ACTION_PACKAGE
            + "ACTION_MESSAGE_SEND";
    public static final String ACTION_STATUS_SENT = Constants.ACTION_PACKAGE
            + "ACTION_STATUS_SEND";
    public static final String ACTION_DRAFTS_SENT = Constants.ACTION_PACKAGE
            + "ACTION_DRAFTS_SENT";
