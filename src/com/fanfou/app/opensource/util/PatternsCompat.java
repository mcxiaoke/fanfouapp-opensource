...
public class PatternsCompat {
    ...
    public static final Pattern TOP_LEVEL_DOMAIN = Pattern
            .compile(PatternsCompat.TOP_LEVEL_DOMAIN_STR);
    ...
    public static final Pattern WEB_URL = Pattern
            .compile("((?:(http|https|Http|Https|rtsp|Rtsp):\\/\\/(?:(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)"
                    ...
                    + "\\.\\+\\!\\*\\'\\(\\)\\,\\;\\?\\&\\=]|(?:\\%[a-fA-F0-9]{2})){1,25})?\\@)?)?"
                    + "((?:(?:["
                    + PatternsCompat.GOOD_IRI_CHAR
                    + "]["
                    + PatternsCompat.GOOD_IRI_CHAR
                    + "\\-]{0,64}\\.)+" // named host
                    + PatternsCompat.TOP_LEVEL_DOMAIN_STR_FOR_WEB_URL
    ...
    public static final Pattern DOMAIN_NAME = Pattern.compile("((((["
            ...
            + PatternsCompat.GOOD_IRI_CHAR + "\\-]*)*["
            + PatternsCompat.GOOD_IRI_CHAR + "]\\.)+"
            + PatternsCompat.TOP_LEVEL_DOMAIN + ")|"
